...
class Manga extends Component {
  ...
  componentWillMount() {
    ...
    if(state && state.manga.image === null) {
      state.manga.image = "https://i.ytimg.com/vi/yUHJ1HU9jtI/maxresdefault.jpg";
    }
  }
  render() {
    const { state }  = this.props.location;
    ...
    return (
      <div className="App">
        ...
        {/* {!state.length && <img src={loader} style={{ margin: '10px 50px 0px 26%', width: '45%' }} />} */}
        ...
        {state && <div>
          ...
          {state.manga && <div style={DetailContainer}>
            ...
            {state.manga.image[2] == "/" ? <img src={`https://cdn.mangaeden.com/mangasimg/${state.manga.image}`} style={img} /> :
              <img src={state.manga.image} style={img} />}
