...
const BrokenImage = React.lazy(() => import('./views/Base/Cards/brokenImage'));
const BrokenChapter = React.lazy( () => import('./views/Base/Cards/brokenChapter'))
...
const routes = [
  ...
  { path: '/base/missingImages', name: 'Missing-Images', component: BrokenImage },
  { path: '/base/failedChapter', name: 'Missing-Chapters-Images', component: BrokenChapter },
...
//  { path: '/base/failedChapters', name: 'Failed-chapters', component: Carousels },
  ...
  { path: '/icons', name: 'Icons', component: logout },
